...
//   name: string;
//   email: string;
//   images: FileList; // Accept multiple files
// }
...
//     images: yup
//       .mixed<FileList>()
//       .nullable() // Allows null/undefined values
//       .test("fileSize", "File size must be less than 2MB", (value) => {
//         return !value || (value && value.length > 0 && value[0].size <= 2 * 1024 * 1024);
//       })
//       .test("fileType", "Only JPG, PNG, and JPEG formats are allowed", (value) => {
//         return (
//           !value ||
//           (value.length > 0 && ["image/jpeg", "image/png", "image/jpg"].includes(value[0].type))
//         );
//       }),
//   })
//   const {
...
//           formData.append("images", file); // Send as array
//         });
//       }
...
//           className={`p-3 border border-green-300 outline-none rounded cursor-pointer ${errors.name && "input-error"
//             }`}
//           type="text"
//           placeholder="Name"
//         />
...
//           className={`p-3 border border-green-300 outline-none rounded cursor-pointer ${errors.email && "input-error"
//             }`}
//           type="text"
//           placeholder="Email"
//         />
...
//           className={`p-3 border border-green-300 outline-none rounded cursor-pointer ${errors.images && "input-error"
//             }`}
//           type="file"
